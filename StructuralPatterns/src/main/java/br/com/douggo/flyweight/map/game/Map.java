package br.com.douggo.flyweight.map.game;

import br.com.douggo.flyweight.map.model.Pixel;
import br.com.douggo.flyweight.map.model.PixelTypeFactory;
...
public class Map {
	...
	public void drawMap() {
		...
		System.out.println(String.format("\nYou have %d tries left", trysRemaining));
	}
